...
class CreateShortUrlUseCaseTest {
    ...
    public void testCreateShortUrlSuccessful() {
        ...
        when(idGeneratorPort.generate()).thenReturn("xUk340p");
...
//        assertEquals(output.shortUrl().length(), 7);
    ...
    public void testDoNotCreateShortUrlWithAnNullUrl() {
        ...
        assertThrows(IllegalArgumentException.class, () -> createShortUrlUseCase.execute(input));
